  ...
  <div className="container mx-auto max-w-7xl py-6 space-y-10">
    ...
    <StaggerContainer staggerDelay={0.15}>
      <div className="grid md:grid-cols-3 gap-6">
        {services.map((s, i) => (
          <ScrollReveal key={i} direction="up" duration={0.6}>
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 text-center hover:shadow-md transition-all duration-300 flex flex-col items-center space-y-4 relative overflow-hidden group h-full">
